...
class GalleryItem {
  ...
  factory GalleryItem.fromJson(Map<String,dynamic> json) => GalleryItem(
    ...
    tagsFromApi: json['tagsFromApi'] != null ? (json['tagsFromApi'] as List? ?? []).map((e) => e as String).toList() : null,
  ...
  GalleryItem copyWith({
    ...
    Optional<double?>? imgHeight,
    Optional<double?>? imgWidth,
    ...
    Optional<List<String>?>? tagsFromApi,
